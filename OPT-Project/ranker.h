...
//
// SOURCE: https://sites.google.com/site/jivsoft/Home/compute-ranks-of-elements-in-a-c---array-or-vector
//
...
inline void get_ranks(const vector<T>& v, vector<S>& w,
...
template <class T, class S>
inline void get_ranks(const T* d, uint size, vector<S>& w,
	const string& method = "average")
{
